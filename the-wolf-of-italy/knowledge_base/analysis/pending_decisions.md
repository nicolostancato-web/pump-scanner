...
- **seen_protocols.md** (ANALISTA run 14:26 2026-04-24):
  - 3 BP (KAT, CHIP, SKR) tutti con stato **REJECTED**
...
- **decisions_queue.md**: Vuota — nessuna decisione in attesa
- **pending_deployment.md**: Ancora vuota — nessun BP in attesa di deploy

---

## Prossimi eventi

- **Hunter run**: 07:00 Roma oggi — nuove opportunità in arrivo
